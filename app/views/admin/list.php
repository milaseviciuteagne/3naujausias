<?php require VIEW_ROOT . '/templates/header.php'; ?>
            ...
            <tbody>
                <?php foreach ($pages as $page): ?>
                    <tr>
                        ...
                        <td><a href="<?php echo BASE_URL; ?>/admin/delete.php?id=<?php echo e($page['id']); ?>"onclick="return confirm('Are you sure you want to delete?')">Delete</a></td>
                    </tr>
                <?php endforeach; ?>
            </tbody>
        </table>
    ...
    <a href="<?php echo BASE_URL; ?>/admin/add.php">Add new post</a>
